...
/** 2×2 Album Art Widget */
class AlbumArtWidget2x2 : BaseWidgetProvider() {
    override val layoutResId = R.layout.widget_album_2x2
    ...
    override fun bindViews(
        ...
        if (artBitmap != null)
            views.setImageViewBitmap(R.id.widget_album_art, roundedBitmap(artBitmap, 20f, ctx))
        else
